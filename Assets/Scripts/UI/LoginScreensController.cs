...
namespace FishMuseum.UI
{
    ...
    public class LoginScreensController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (GameSession.Instance != null && GameSession.Instance.PeekShowQuizResultOnReturn())
            {
                Debug.Log("[LoginScreensController] Quiz sonuç ekranına dönüş algılandı. MainApp_UI açılıyor.");
